...
@synthesize myTableView = _myTableView, selectIndex = _selectIndex;
...
-(void)cancleButtonClicked:(UIButton*)button{
    ...
    //收起展开的cell
    self.selectIndex = nil;
    [_myTableView reloadRowsAtIndexPaths:[NSArray arrayWithObject:indexPath] withRowAnimation:UITableViewRowAnimationAutomatic];
}
